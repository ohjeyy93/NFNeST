...
process snpfilter {
    ...
    script:
        """
        python $baseDir/snpreport1-53-4.py -v1 ${vcf_path2} -v2 ${vcf_path1} -b1 ${bam_path1} -o1 ${sample} -e1 $baseDir/candidates.xlsx -e2 $baseDir/voinew2.csv -f1 $baseDir/New_6_genes.fa -b2 $baseDir/mdr.bed
