...
for x in range(len(df2Gene)):
    ...
    elif df2Gene[x] == "mitochondrial_genome":
...
for k in range(len(df2Gene)):
    if df2Gene[k] == "Pfcrt":
        ...
        wholepotlist1.append([df2Gene[k],str(df2AAPos[k])])
...
for x in wholepotlist1:
    wildgene1+=[x[0]]
    wildgeneAApos1+=[x[1]]
    wildAAprev1+=[AAuntranslatewilddic1[x[0],x[1]]]
    wildAAtrans1+=[AAtranslatewilddic1[x[0],x[1]]]
    if AAuntranslatewilddic1[x[0],x[1]]==AAtranslatewilddic1[x[0],x[1]]:
        wildtype1+=["Wildtype"]
    else:wildtype1+=["notwildtype"]
...
#print(len(AAlist22))
#print(Genelist2)
for x in range(len(filteredGenelist2)):
    #print(len(Genelist2))
    #print(len(Genelist1))
    #print(len(AAPoslist12))
    #print(len(AAlist21))
    #print(len(AAlist22))
    wholeAAlist1.append([filteredGenelist2[x],filteredAAPoslist12[x],filteredAAlist21[x],filteredAAlist22[x]])
for k in range(len(df1Gene)):
    if df1Gene[k] == "Pfcrt":
...
#    print(x)
    ...
    #print(AAlist21[x])
    #print(AAlist22[x])
filteredcandidateslist1=candidateslist1
filteredreportablelist1=reportablelist1
