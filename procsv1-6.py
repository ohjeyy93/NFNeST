...
ChrList1 = ["Pfdhps", "Pfdhfr", "Pfmdr1", "PfK13", "Pfcrt", "MT"]
Genelist2 = ["Pfdhps", "Pfdhfr", "Pfmdr1", "PfK13", "Pfcrt", "MT"]
Distancelist1 = [1487,1827, 2157,  2181, 2586]
Pfcrtgene1=['K76T', "C72S", "V73V", "M74I", "N75E", "T93S", "H97Y", "F145I", "I218F", "A220S", "Q271E", "N326S", "M343L","C350R", "G353V", "I356T", "R371I"]
Pfcrtlist1=[76,72,73,74,75,93,97, 145,218, 220,271,326, 343, 350,353, 356,371,]
Pfmdr1gene1=["N86Y", "Y184F", "S1034C", "N1042D", "D1246Y"]
Pfmdr1=[86, 184, 1034, 1042, 1246]
Pfk13gene1=["P441L", "F446I", "G449A", "C469F", "C469Y", "M476I", "A481V", "R515K", "P527H", "N537I", "N537D", "G538V", "R539T", "I543T", "P553L", "R561H", "V568G", "P574L", "A578S", "C580Y", "D584V", "R622I", "A675V"]
Pfk13=[441,446, 449, 469, 469, 476, 481, 515, 527, 537, 537, 538, 539, 543, 553, 561, 568, 574, 578, 580, 584, 622,675]
Pfdhfrgene1=["A16V", "N51I", "C59R", "S108N","I164L"]
Pfdhfr=[16, 51, 59, 108, 164]
Pfdhpsgene1=["S436A", "S436F", "S436H", "A437G", "K540E", "A581G", "A613T", "A613S"]
Pfdhps=[436,436, 436, 437,540,581,613, 613]
MTgene1=["I258M", "Y268N", "Y268S", "Y268C"]
MT=[258,268,268,268]
...
for x in range(len(MTgene1)):
    ...
    if "/" in MTgene1[x]:
        ...
        Genelist3+=["MT"]
        RefAA1+=[MTgene1[x][0]]
        AAPos1+=[MTgene1[x][1:len(MTgene1[x])-3]]
        AltAA1+=[MTgene1[x][-3]]
        AltAA1+=[MTgene1[x][-1]]
        AAPos1+=[MTgene1[x][1:len(MTgene1[x])-3]]
    if "/" not in MTgene1[x]:
        AAPos1+=[MTgene1[x][1:len(MTgene1[x])-1]]
    if "/" not in MTgene1[x]:
        AltAA1+=[MTgene1[x][-1:]]
...
d8= {'MT': MTgene1, 'Distance': MT}

d9= {'Chr': ChrList1, 'Gene': Genelist3, 'RefAA': RefAA1, 'AAPos': AAPos1, 'AltAA': AltAA1}
...
df9.to_csv('voinew2.csv', index=False,) 
