...
with open("New_6_genes.fa", "r") as f4:
    tempGene1=""
    codoncount=0
    for line in f4:
        if count!=1:
...
for x in range(len(AAPoslist12)):
    if float(AAPoslist12[x]) in df1AAPos or float(AAPoslist12[x]) in df2AAPos:
        ...
        filteredReflist2+=[Reflist2[x]]
        filteredAltlist2+=[Altlist2[x]]
        filteredAAlist21+=[AAuntranslatewilddic1[Genelist2[x],AAPoslist12[x]]]
        filteredAAlist22+=[AAtranslatewilddic1[Genelist2[x],AAPoslist12[x]]]
        ...
        filteredAFlist1+=[AFlist1[x]]
        #print(AFlist1[x])
        if AAuntranslatewilddic1[Genelist2[x],AAPoslist12[x]]==AAtranslatewilddic1[Genelist2[x],AAPoslist12[x]]:
            #print("False")
