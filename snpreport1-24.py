...
for x in keywords:
    ...
    for y in x:
        currentcodon+=y
    if currentcodon == "TTT" or "TTC":
        codondic[currentcodon]="Phe"
    elif currentcodon == "TTA" or "TTG": 
        codondic[currentcodon]="Leu"
    elif currentcodon == "CTT" or "CTC" or "CTA" or "CTG":
        codondic[currentcodon]="Leu"
    elif currentcodon == "ATT" or "ATC" or "ATA":
        codondic[currentcodon]="Ile"
    elif currentcodon == "ATG":
        codondic[currentcodon]="Met"
    elif currentcodon == "GTT" or "GTC" or "GTA" or "GTG":
        codondic[currentcodon]="Val"
    elif currentcodon == "TCT" or "TCC" or "TCA" or "TCG":
        codondic[currentcodon]="Ser"
    elif currentcodon == "CCT" or "CCC" or "CCA" or "CCG": 
        codondic[currentcodon]="Pro"
    elif currentcodon == "ACT" or "ACC" or "ACA" or "ACG":
        codondic[currentcodon]="Thr"
    elif currentcodon == "GCT" or "GCC" or "GCA" or "GCG":
        codondic[currentcodon]="Ala"
    elif currentcodon == "TAT" or "TAC":
        codondic[currentcodon]="Tyr"
    elif currentcodon == "CAT" or "CAC":
        codondic[currentcodon]="His"
    elif currentcodon == "CAA" or "CAG":
        codondic[currentcodon]="Gln"
    elif currentcodon == "AAT" or "AAC":
        codondic[currentcodon]="Asn"
    elif currentcodon == "AAA" or "AAG":
        codondic[currentcodon]="Lys"
    elif currentcodon == "GAU" or "GAC":
        codondic[currentcodon]="Asp"
    elif currentcodon == "GAA" or "GAG":
        codondic[currentcodon]="Glu"
    elif currentcodon == "TGT" or "TGC":
        codondic[currentcodon]="Cys"
    elif currentcodon == "TGG":
        codondic[currentcodon]="Trp"
    elif currentcodon == "AGA" or "AGG" or "CGT" or "CGC" or "CGA" or "CGG":
        codondic[currentcodon]="Arg"
    elif currentcodon == "AGT" or "AGC":
        codondic[currentcodon]="Ser"
    elif currentcodon == "GGT" or "GGC" or "GGA" or "GGG":
...
#PfMDR1  1   4260    PfMDR1  .   +   1   4260    0   1   4260,   1,
   ...
   # print(len(Genelist1))
            ...
            for line in f2:
                ...
                for k in GeneNamelist1:
                    if line.find(k)!=-1:
                        ...
                        #print(tempGene1)
                        for l in range(len(Genelist2)):
                            #print((l))
                            #print((tempGene1))
                            #print(l == tempGene1)
                            if Genelist2[l] == tempGene1:
                                tempPOS1+=[int(POSlist2[l])]
                                tempAlt1+=[Altlist2[l]]
                for k in GeneNamelist1:
                    if line.find(k)==-1:
                        tempcount+=1
    ...
    for x in range(len(AAPoslist12)):
        if int(AAPoslist12[x]) in df1AAPos or  int(AAPoslist12[x]) in df2AAPos:
            #print(AAPoslist12[x])
