...
#PfMDR1  1   4260    PfMDR1  .   +   1   4260    0   1   4260,   1,
   ...
   # print(len(Genelist1))
        ...
        for word in line.split():
            ...
            if word.startswith("p."):
                ...
                for x in word:
                    ...
                    #print(word[5+len(temppos):5+len(temppos)+3])
                #print(word[5+len(temppos):5+len(temppos)+3])
                if word[5+len(temppos):5+len(temppos)+3] not in AAdic:
                    wholefilnumsx=wholefilnumsx[:-1]
                    wholefilnums=wholefilnums[:-1]
                    break
    #print(wholefilnums)
        ...
        for word in line.split():
            ...
            if line.startswith("#")==False:
                if word.startswith("AC=") or word.startswith("AB="):
                    ...
                    #print(line)
                    count2=0
                    for x in wholefilnums:
                        #print(x)
                        #print(wholefilnumsx[count])
                        #print(POSlist2)
                        #print(wholefilnumsx[count2])
                        if word.find(x)!=-1 and str(int(wholefilnumsx[count2])) not in POSlist2:
                            Genelist2+=[word1]
                            POSlist2+=[wholefilnumsx[count2]]
    ...
    for k in range(len(df1Gene)):
        ...
        elif df1Gene[k] == "mitochondrialgenome":
    ...
    for k in range(len(df2Gene)):
        ...
        elif df2Gene[k] == "mitochondrialgenome":
