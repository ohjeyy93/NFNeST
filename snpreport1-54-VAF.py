...
for line in f3:
    ...
    for word in line.split():
        ...
        if count==9 and len(tempword)==1:
            for x in word.split(","):
                tempword2+=[x]
        if count==10 and len(tempword2)==1:
            for x in word.split(","):
                tempword3+=[x]
        if count==1:
            tempgeneval1=word
    ...
    if len(tempword)==4:
        ...
        if len(tempword2)==1 and len(tempword3)==2:
            DepthVal3[tempgeneval1,tempposval1]=[tempword3[2]/tempword2]
    if len(tempword)==1 and len(tempword2)==2:
        DepthVal[tempgeneval1,tempposval1]=[tempword2[2]/tempword]
        DepthVal3[tempgeneval1,tempposval1]=[tempword2[2]/tempword]
