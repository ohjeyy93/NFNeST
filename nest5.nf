...
params.reads = $params.input.fastq_path+"/*/*_insilico{\d+ }{\d+}{\d+}{\d+}{\d+}{\d+}{\d+}_r{1,2}.fastq.gz"
...
alinger_path = $params.input.
smt_path = $params.input.
bft_path = "$params.input.bft_def"
gatk_path = $params.input.
sam_name = $params.input.
file_list = $params.input.
ref_path = $params.input.
adp_path = $params.input.
bed_path = $params.input.
out_dir = $params.input.
aligner = $params.input.
pic_path = "$params.input.pic_def"
voi_path = $params.input.
java_path = $params.input.
sra_path = "$params.input.sra_def"
purge = $params.input.    
sra_list = $params.input.
