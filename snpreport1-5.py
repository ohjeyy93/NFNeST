...
with open(args.filtered, "r") as f1:
   ...
   # print(len(Genelist1))
    ...
    d3={"Gene":Genelist2, "BasePOS":POSlist2, "Ref":Reflist2, "Alt":Altlist2, "AAref":AAlist21, "AAalt":AAlist22, "AAPOS":AAPoslist12, "BaseDepth":depthlist2up, "AF": AFlist1, "Mutation": mutationlist1, "QD": QDlist1, "SOR":SORlist1, "MQ":MQlist1, "MQRankSum":MQRankSumlist1, "Filter":filterlist1}
