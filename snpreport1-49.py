                ...
                if word1!="":
                    ...
                    for x in range(len(Genelist1)):
                        ...
                        if word1== Genelist1[x] and word== POSlist1[x] and line.startswith("#")==False:
                            ...
                            #print(filternumber)
                            if line.find("DP4=") != -1:
                                firstcomma=line.find("DP4=")+line[line.find("DP4=")::].find(",")
                                #firstnumber=line[line.find("DP4=")+4:line.find("DP4=")+line[line.find("DP4=")::].find(",")]
                                #print([line[line.find("DP4=")+4:line.find("DP4=")+line[line.find("DP4=")::].find(";")]])
                                secondcomma=firstcomma+line[firstcomma+1::].find(",")+1
                                thirdcomma=secondcomma+line[secondcomma+1::].find(",")+1
                                #firstnumber=([line[line.find("DP4=")+4:line.find("DP4=")+line[line.find("DP4=")::].find(";")]])
                                firstnumber=(line[line.find("DP4=")+4:firstcomma])
                                #secondnumber=(line[line.find("DP4=")+4:firstcomma])
                                secondnumber=(line[firstcomma+1:secondcomma])
                                thirdnumber=(line[secondcomma+1:thirdcomma])
                                #print(line[secondcomma+1:thirdcomma])
                                fourthnumber=(line[thirdcomma+1:thirdcomma+line[thirdcomma::].find(";")])
                                #print(firstnumber)
                                #print(secondnumber)
                                #print(thirdnumber)
                                #print(fourthnumber)
                                #print(firstnumber)
                                DP4list1+=[(int(thirdnumber)+int(fourthnumber))/(int(firstnumber)+int(secondnumber)+int(thirdnumber)+int(fourthnumber))]
                                #print([(int(thirdnumber)+int(fourthnumber))/(int(firstnumber)+int(secondnumber)+int(thirdnumber)+int(fourthnumber))])
                                #print(line[secondcomma+1])
                                #print(firstnumber)
                                #print(line[line.find("DP4=")+line[line.find("DP4=")::].find(",")::].find(","))
                                #print(line[line.find("DP4=")+4:line.find("DP4=")+line[line.find("DP4=")::].find(",")])
                                #print(line[line[line.find("DP4=")+4:line.find("DP4=")+line[line.find("DP4=")::].find(",")]:line[line[line.find("DP4=")+4:line.find("DP4=")+line[line.find("DP4=")::].find(",")]::].find(",")])
                                #print(line[line.find("DP4=")+line[line.find("DP4=")::].find(","):line.find("DP4=")+line[line.find("DP4=")::].find(",")+line[line.find("DP4=")+line[line.find("DP4=")::].find(",")::].find(",")])
                                
                                #tempDP4list+=[[line[line.find("DP4=")+4:line.find("DP4=")+line[line.find("DP4=")::].find(",")]]]
                                #DP4list1+=[line[line.find("DP4=")+4:line.find("DP4=")+line[line.find("DP4=")::].find(";")]]
                                #print([line[line.find("DP4=")+4:line.find("DP4=")+line[line.find("DP4=")::].find(";")]])
                            if line.find("DP4=") == -1 and line.find(":AD:") != -1:
                                #print("True")
                                firstsemicolon=line.find("GL")+line[line.find("GL")::].find(":")
                                secondsemicolon=firstsemicolon+line[firstsemicolon+1::].find(":")+1
                                thirdsemicolon=secondsemicolon+line[secondsemicolon+1::].find(":")+1
                                firstcomma=secondsemicolon+line[secondsemicolon+1::].find(",")+1
                                firstnumber=line[secondsemicolon+1:firstcomma]
                                #print(len(firstnumber))
                                secondnumber=line[secondsemicolon+len(firstnumber)+2:thirdsemicolon]
                                DP4list1+=[int(secondnumber)/(int(firstnumber)+int(secondnumber))]
                            if line.find("DP4=") == -1 and line.find(":AD:") == -1:
                                DP4list1+=["None"]
                                #print(line[firstnumber+1:thirdsemicolon])
