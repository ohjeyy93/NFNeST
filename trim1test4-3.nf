...
params.genome = "$baseDir/ref/pfalciparum/GCF_000002765.5_GCA_000002765_genomic.fa"
params.bed = "$baseDir/ref⁩/pfalciparum⁩/mGCF_000002765.5_GCA_000002765_genomic.fa.bed"
...
process GenerateVCFHap {
    ...
    script:
        """
        $baseDir/gatk-4.1.9.0/gatk HaplotypeCaller -R $baseDir/GCF_000002765.5_GCA_000002765_genomic.fa -I ${bam_path} -O ${sample}-2.vcf \\
...
process annotate {
    ...
    script:
        """
        java -Xmx8g -jar $baseDir/snpEff/snpEff.jar GCF_000002765.5_GCA_000002765_genomic ${vcf_path1} > ${sample}-1.ann.vcf
        java -Xmx8g -jar $baseDir/snpEff/snpEff.jar GCF_000002765.5_GCA_000002765_genomic ${vcf_path2} > ${sample}-2.ann.vcf
        java -Xmx8g -jar $baseDir/snpEff/snpEff.jar GCF_000002765.5_GCA_000002765_genomic ${vcf_path3} > ${sample}-3.ann.vcf
        """
...
process merge {
    ...
    script:
        ...
        python $baseDir/annotate.py -r $baseDir/GCF_000002765.5_GCA_000002765_genomic.fa -b $baseDir/GCF_000002765.5_GCA_000002765_genomic.fa.bed -o final_${sample} -v1 ${vcf_path1} -v2 ${vcf_path2} -v3 ${vcf_path3} -m ${bam_path} -voi $baseDir/ref/pfalciparum/Reportable_SNPs.csv -name ${sample}
        """
}
...
process variant {
    ...
    script:
        """
        java -jar $baseDir/snpEFF/SnpSift.jar varType final_${sample}.vcf > final_${sample}_SNP.vcf
        """
