...
#print(testdicttrans22["PfMDR1"])
#print(len(testdicttrans22["PfMDR1"]))
#############################################
###############translation applied############
#############################################
...
#print(testdicttrans22["PfMDR1"])
#print(testdicttransAA1["PfMDR1"])
#print(dicttransAA1["PfCRT"])
#for x in dicttransAA1["PfCRT"]:
#    print(x)
#print(dicttrans22)

#for x in dicttrans2:
#    if dicttrans2[x]==dicttrans1[x]:
#        print("True")
#print(dicttrans2)
        #print(y)

                #for y in range(len(bedname1[x][0])):
                    #print(dictrange[bedname1[x]][0][y])
                    #print(dictrange[bedname1[x]][1][y])
                #    for z in range(dictrange[bedname1[x]][0][y],dictrange[bedname1[x]][1][y]):
                #        print(z)
...
#PfMDR1Startlist1=[1]
#PfMDR1Endlist1=[x+y for x,y in zip([1],[4260])]
#PfDHPSStartlist1=[1,315,2304]
#PfDHPSEndlist1=[x+y for x,y in zip([1,315,2302],[135,1865,113])]
#mitochondrialgenomeStartlist1=[3492]
#mitochondrialgenomeEndlist1=[x+y for x,y in zip([3492],[1130])]



AAtranslatedic={}
AAuntranslatewilddic1={}
AAtranslatedic2={}
AAtranslatewilddic1={}
AAPOSdic1={}
    ...
    for line in f4:
            ...
            for x in range(len(PfCRTStartlist1)):
                ...
                for y in range(PfCRTStartlist1[x]-1,PfCRTEndlist1[x]+1):
                    ...
                    if tempcount==1:
                        ...
                        codoncount+=1
                        AAuntranslatewilddic1[tempGene1,str(codoncount)]=AAdic[codondic[line.strip()[y:y+3]]]
                        AAPOSdic1[tempGene1,y+1]=str(codoncount)
                    if tempcount==2:
                        AAtranslatedic[tempGene1,y+1]=tempcodon
                        AAuntranslatewilddic1[tempGene1,str(codoncount)]=tempcodon
                        AAPOSdic1[tempGene1,y+1]=str(codoncount)
                    if tempcount==3:
                        AAtranslatedic[tempGene1,y+1]=tempcodon
                        AAuntranslatewilddic1[tempGene1,str(codoncount)]=tempcodon
        ...
        if count==2 and tempGene1=="mitochondrial_genome":
            ...
            for x in range(len(mitochondrialgenomeStartlist1)):
                tempcount=0
                tempcodon=""
                for y in range(mitochondrialgenomeStartlist1[x]-1,mitochondrialgenomeEndlist1[x]+1):
                    tempcount+=1
                    #print(tempGene1,y)
                    if tempcount==1:
                        tempcodon=AAdic[codondic[line.strip()[y:y+3]]]
...
#print(AAPOSdic1)
for x in range(len(Genelist2)):
    #print(Genelist2[x],(AAPoslist12[x]))
    #print(AAPOSdic1["DHFR", 38 ])
    #print(AAPOSdic1["mitochondrial_genome", 4952])
    if (Genelist2[x],int(POSlist2[x])) in AAPOSdic1:
        if [Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]] in combineddflist1 or [Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]] in combineddflist2:
            #print("True")
            #print(AAPoslist12[x])
            ...
            for x in range(len(PfCRTStartlist1)):
                ...
                for y in range(PfCRTStartlist1[x]-1,PfCRTEndlist1[x]+1):
                    ...
                    if tempcount==1:
                        ...
                        AAtranslatewilddic1[tempGene1,str(codoncount)]=AAdic[codondic[line.strip()[y:y+3]]]
                    if tempcount==2:
                        AAtranslatewilddic1[tempGene1,str(codoncount)]=tempcodon
                ...
                for y in range(mitochondrialgenomeStartlist1[x]-1,mitochondrialgenomeEndlist1[x]+1):
                    ...
                    if tempcount==4:
                        if len(line.strip()[y::])>2:
                            ...
                            codoncount+=1
                            AAtranslatewilddic1[tempGene1,str(codoncount)]=AAdic[codondic[line.strip()[y:y+3]]]
#print(filteredGenelist2)
#print(filteredAAPoslist12)
#print(filteredPoslist2)
with open("translatedfasta.fa", "r") as f4:
    #print("test")
    count=0
    wholetranGene1=[]
        ...
        if line.find("ANN[*].EFFECT")==-1:
            ...
            for word in line.split():
                ...
                if count==1:
                    tempPOS1=word
                if count==2:
                    if [tempGene1,tempPOS1] not in customGenePOSSet1:
                        customGenelist1+=[tempGene1]
                        customPOSlist1+=[tempPOS1]
                        customGenePOSSet1+=[[tempGene1,tempPOS1]]
                count+=1
...
customGeneset1=[]
customAA1=[]
for k in range(len(customGenelist1)):
    customGeneset1+=[[customGenelist1[k],customPOSlist1[k]]]
    ...
    for word in line.split():
        ...
        if count==1:
            ...
            if word1!="":
                ...
                #print(POSlist1)
                #print(Genelist1)
                for x in range(len(customGenelist1)):
                    #print(str(int(POSlist1[x])-1))
                    #if word1== Genelist1[x]:print(word1,word)
                    #print(POSlist1)
                    #print(word)
                    ...
                    #print(POSlist1[x])
                    #if word == POSlist1[x]: print("yes")
                    if word1== customGenelist1[x] and word== customPOSlist1[x] and line.startswith("#")==False:
                        #print(word1)
                        #print(word)
                        #print(word)
                        #print(word)
                        ...
                        #print("test"+POSlist1[x])
                        #print(Genelist1[x],POSlist1[x])
                        customGenelist2+=[customGenelist1[x]]
                        customPOSlist2+=[customPOSlist1[x]]
                        customGenePosSet1+=[[customGenelist1[x],customPOSlist1[x]]]
                    ...
                    if word.startswith("AC=") or word.startswith("AB="):
                        ...
                        for x in range(len(wholefilnums)):
                            ...
                            if word.find(wholefilnums[x])!=-1 and str(word.find(wholefilnums[x])+len(wholefilnums[x])+1).isdigit()==False and [word1,wholefilnumsx[x]] in Geneset1 and [word1,str(int(wholefilnumsx[x]))] not in GenePosSet1:
                                ...
                                #print(word1)
                                #print(wholefilnumsx[x])
                                customGenelist2+=[word1]
                                #print(wholefilnumsx[x])
                                customPOSlist2+=[wholefilnumsx[x]]
                                #"QD": QDlist1, "SOR":SORlist1, "MQ":MQlist1, "MQRankSum":MQRankSumlist1,
                                customGenePosSet1+=[[word1,str(int(wholefilnumsx[x]))]]
                                if line.find("CUSTOM&annotation")!=-1:
                            #print(line.find("CUSTOM&annotation"))
                            #print(line[2::])
                            #print(line[line.find("CUSTOM&annotation")+18::])
...
for x in range(len(Genelist2)):
    if (Genelist2[x],int(POSlist2[x])) in AAPOSdic1:
        #print([Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]])
        if [Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]] in combineddflist1 or [Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]] in combineddflist2:
            combinedGenePOSlist1+=[[Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]]]


for x in range(len(Genelist2)):
    #print(Genelist2[x],int(POSlist2[x]))
    if (Genelist2[x],int(POSlist2[x])) in AAPOSdic1:
        #print([Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]])
        if [Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]] in combineddflist1 or [Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]] in combineddflist2:
    #print(AAPoslist12[x])
            ...
            filteredReflist2+=[Reflist2[x]]
            filteredAltlist2+=[Altlist2[x]]
            filteredAAlist21+=[AAuntranslatewilddic1[Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]]]
            filteredAAlist22+=[AAtranslatewilddic1[Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]]]
            #print(AAuntranslatewilddic1[Genelist2[x],AAPoslist12[x]])
            #print(AAtranslatewilddic1[Genelist2[x],AAPoslist12[x]])
            filteredAAPoslist12+=[AAPOSdic1[Genelist2[x],int(POSlist2[x])]]
            filteredcodondepthlist2+=[codondepthlist2[x]]
            filteredAFlist1+=[AFlist1[x]]
            if AAuntranslatewilddic1[Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]]==AAtranslatewilddic1[Genelist2[x],AAPOSdic1[Genelist2[x],int(POSlist2[x])]]:
                #print("False")
...
for y in wholepotlist1:
    ...
    for x in range(len(combinedGenePOSlist1)):
        #count+=1
        if [y[0],y[1]] == combinedGenePOSlist1[x]:
        ...
        if x==len(combinedGenePOSlist1)-1 and ([y[0],y[1]] not in combinedGenePOSlist1) and ([y[0],y[1]] not in combinedwildgeneAA):
            combinedwildgeneAA+=[[y[0],y[1]]]
            filteredGenelist22+=[y[0]]
            filteredPoslist22+=["NA"]
            filtereddepthlist2up2+=["NA"]
            filteredReflist22+=["NA"]
            filteredAltlist22+=["NA"]
            filteredAAlist212+=[AAuntranslatewilddic1[y[0],y[1]]]
            filteredAAlist222+=[AAtranslatewilddic1[y[0],y[1]]]
