    ...
    for y in range(len(dictrange[bedname1[x]][0])):
        ...
        if len(dictrange[bedname1[x]][0])==1:
            for z in range(dictrange[bedname1[x]][0][y]-1,dictrange[bedname1[x]][1][y]-1):
                ...
                #print(AAcount)
                #print(count)
                if [bedname1[x],str(AAcount)] in wholepotlist1 and bedname1[x]=="mitochondrial_genome":
                    #if 
...
for x in wholepotlist1:
    ...
    for y in depthlist1:
        ...
        if x[0] == y[0] and str(posdic1[x[0],x[1]])==y[1]:
            ...
            #    print("True")
            wildic1[x[0],x[1]]=y[2]
        if x[0] == y[0] == "mitochondrial_genome" and str(posdic1[x[0],x[1]])==str(int(y[1])-3493):
            wildic1[x[0],x[1]]=y[2]
            #print(y)
            #print(y[2])
            #print(x[0],x[1])
