...
process annotate {
    ...
    script:
        """
        java -Xmx8g -jar $baseDir/snpEff/snpEff.jar New_6_genes ${vcf_path1} > ${sample}-1.ann.vcf
        java -Xmx8g -jar $baseDir/snpEff/snpEff.jar New_6_genes ${vcf_path2} > ${sample}-2.ann.vcf
        java -Xmx8g -jar $baseDir/snpEff/snpEff.jar New_6_genes ${vcf_path3} > ${sample}-3.ann.vcf
        """
