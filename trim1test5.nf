...
process annotate {
    ...
    script:
        """
        java -Xmx8g -jar $baseDir/snpEff/snpEff.jar Plasmodium_malariae_gca_900088575 ${vcf_path1} > ${sample}-1.ann.vcf
        java -Xmx8g -jar $baseDir/snpEff/snpEff.jar Plasmodium_malariae_gca_900088575 ${vcf_path2} > ${sample}-2.ann.vcf
        java -Xmx8g -jar $baseDir/snpEff/snpEff.jar Plasmodium_malariae_gca_900088575 ${vcf_path3} > ${sample}-3.ann.vcf
        """
...
process merge {
    ...
    script:
        ...
        python $baseDir/annotate.py -r $baseDir/mdr.fa -b $baseDir/mdr.bed -o final_${sample} -v1 ${vcf_path1} -v2 ${vcf_path2} -v3 ${vcf_path3} -m ${bam_path} -voi $baseDir/ref/pfalciparum/Reportable_SNPs.csv -name ${sample}
        """
}